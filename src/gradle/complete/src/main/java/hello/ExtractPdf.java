...
public class ExtractPdf {
	...
	public ExtractPdf(File file, String path) throws SQLException, ClassNotFoundException {
	this.file=file;
	this.path=path;
   ...
   public File extract() throws IOException,TikaException, SAXException, SQLException {
	 ...
	 // System.out.println("TABLE METADATA is created");
      ...
      String newPath="/home/mohamed/linux/2A/PIDR/final/Data/pdf2txt";
      ...
      // String sqlAll = "IF EXISTS (SELECT * FROM  WHERE Column1='SomeValue') UPDATE Table1 SET (...) WHERE Column1='SomeValue' ELSE INSERT INTO Table1 VALUES (...)"
