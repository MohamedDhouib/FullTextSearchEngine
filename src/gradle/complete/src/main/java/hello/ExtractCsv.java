...
public class ExtractCsv {
    ...
    public ExtractCsv(File file, String path) throws SQLException, ClassNotFoundException {
        this.file=file;
        this.path=path;
    ...
    public File extract() throws IOException,TikaException, SAXException, SQLException {
        ...
        hello.CSVTikaParser csvparser = new hello.CSVTikaParser();
        Path p= Paths.get(path);
        BasicFileAttributes attr = Files.readAttributes(p,BasicFileAttributes.class);

        csvparser.parse(inputstream,handler,metadata,pcontext,attr);
        /*PDFParser pdfparser = new PDFParser();
        pdfparser.parse(inputstream, handler, metadata, pcontext);
        */

        String newPath="/home/mohamed/linux/2A/PIDR/final/Data/csv2txt";
       ...
       // String sql="INSERT INTO METADATA " +"VALUES ('"+newPath+"/"+file.getName()+"', '"+type+"', '"+date.substring(0,10)+"')";
